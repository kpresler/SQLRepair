...
public abstract class APIController {
    ...
    /**
     * If `debug` is set, print out the constraints and model that is being
     * generated
     */
     ...
     * @return The resulting JSON String
     */
    static final protected String responseMessage ( final String status,
            final String message ) {
        return toJson( new JSONResponse( status, message ),
                JSONResponse.class );
    }
