...
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('TOSID', 'Source asserted identifier for the entity being mapped to', 0, 0.00, 0, 'MRMAP.RRF');
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('TTYL', 'Term type list for a source', 0, 6.08, 83, 'MRSAB.RRF');
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('VCUI', 'Unique identifier for versioned SRC concept', 0, 4.43, 8, 'MRSAB.RRF');
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('VEND', 'Valid end date for a source', 0, 0.00, 0, 'MRSAB.RRF');
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('VSTART', 'Valid start date for a source', 0, 0.00, 0, 'MRSAB.RRF');
INSERT INTO `alpha3d` (`COL`, `DES`, `MIN`, `AV`, `MAX`, `FIL`) VALUES ('VALUE', 'Value', 0, 14.77, 62, 'MRDOC.RRF');
